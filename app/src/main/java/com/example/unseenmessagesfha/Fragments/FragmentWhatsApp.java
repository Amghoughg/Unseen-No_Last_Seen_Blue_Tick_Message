...
public class FragmentWhatsApp extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_t_whatsapp, container, false);
        Realm.init(v.getContext());

        recyclerView = v.findViewById(R.id.recyclerView_MainWhatsApp);
    ...
    {
        return db.where(AllChat.class).equalTo("AppName","com.whatsapp").sort("DateTime", Sort.DESCENDING).findAll();
    }
    @Override
