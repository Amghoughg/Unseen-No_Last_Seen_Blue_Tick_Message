 ...
 */
public class FragmentSkype extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recyclerView_MainSkype);
    ...
    {
        return db.where(AllChat.class).equalTo("AppName","com.skype.raider").sort("DateTime", Sort.DESCENDING).findAll();
    }
