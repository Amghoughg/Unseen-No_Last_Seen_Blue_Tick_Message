 ...
 */
public class FragmentViber extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_viber, container, false);
        Realm.init(v.getContext());

        recyclerView = v.findViewById(R.id.recyclerView_MainViber);
    ...
    {
        return db.where(AllChat.class).equalTo("AppName","com.viber.voip").sort("DateTime", Sort.DESCENDING).findAll();
    }
