 ...
 */
public class FragmentIMO extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_imo, container, false);
        Realm.init(v.getContext());

        recyclerView = v.findViewById(R.id.recyclerView_MainImo);
    ...
    {
        return db.where(AllChat.class).equalTo("AppName","com.imo.android.imoim").sort("DateTime", Sort.DESCENDING).findAll();
    }
